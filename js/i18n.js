...
(function () {
    ...
    const translations = {
        en: {
            ...
            dopamineHook: "🎉 You're seconds away from a perfect, print-ready passport & visa photo — no studio, no waiting, no cost!",
            statPhotosCreated: '📸 Photos Created',
            statVisitors: '👀 Visitors This Month',
            statCountries: '🌍 Countries Supported',
            statYourPhotos: '🏆 Your Photos Made',
            successToastText: 'Awesome! Your passport photo PDF is ready to download.',
            ...
            suitTitle: '👔 Virtual Suit Changer',
            suitHint: 'Swap casual clothes for a formal suit or blazer — perfect for passport, visa & ID photos.',
            suitNone: 'None',
            suitBlack: 'Black Suit',
            suitNavy: 'Navy Suit',
            suitGrey: 'Grey Blazer',
            suitMaroon: "Women's Blazer",
            suitBlouse: 'Formal Blouse',
